...
class SignUpView extends ConsumerStatefulWidget {
  ...
  const SignUpView({super.key, this.onSignIn});
...
class _SignUpViewState extends ConsumerState<SignUpView> {
  ...
  Future<void> submitEmailAuth() async {
    ...
    try {
      ...
      await auth.registerWithEmailPassword(email, password).timeout(const Duration(seconds: 30));
      ...
      Get.snackbar('Registration Failed', 'Request timed out. Check your connection and try again.',
          snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.redAccent, colorText: Colors.white);
    } catch (e) {
